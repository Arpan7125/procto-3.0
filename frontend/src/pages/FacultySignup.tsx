      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-10">
          <Link to="/" className="inline-flex items-center gap-3 mb-6">
            <div className="w-12 h-12 rounded-xl bg-slate-900 border border-orange-500/20 flex items-center justify-center">
          ...
          <h2 className="text-3xl font-black tracking-tight text-white mb-2">Faculty Registration</h2>
          <p className="text-sm text-slate-500">Create your administrative access portal</p>
        </div>
        ...
        <div className="glass-card rounded-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 bg-gradient-to-r from-orange-500 to-red-500 text-white font-black uppercase tracking-widest text-sm rounded-xl hover:shadow-lg hover:shadow-orange-500/20 transition-all disabled:opacity-50 flex items-center justify-center gap-2"
            >
              {loading && <Loader2 className="w-4 h-4 animate-spin" />}
              {loading ? 'Creating...' : 'Register Portal'}
            </button>
          </form>
